...
if (isset($_POST['button']))
  {
    Mysqli_query($connect,"INSERT INTO nilai_seleksi(id_kriteria, id_supplier, nilai) VALUES('$_POST[id_kriteria]','$_POST[id_supplier]', '$_POST[nilai]')");
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Input Data penilaian</li>
      </ol>
    </section>
    ...
    <div class="col-xs-7">
      ...
      <div class="box box-primary box-solid">
       ...
       <form class="form-horizontal" method="post">
          ...
          <option value="<?php echo $dataalternatif['id_supplier']; ?>"
                >
                <?php echo $dataalternatif['nama_supplier'];?></option>
                <?php } ?>
            ...
            <div class="form-group">
             ...
             <option value="<?php echo $datakriteria['id_kriteria']; ?>">
