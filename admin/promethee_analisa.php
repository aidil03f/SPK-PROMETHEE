...
<!-- style="display:none;"-->
<section class="content" id="perhitungan" style="display:none;">
...
<!-- Main content -->
  <div class="row">
	...
	<table id="example2" class="table table-bordered table-striped">
	  <?php echo "<th>Alternatif (a)</th>";
		    echo "<th>Alternatif (b)</th>";
		    echo "<th>Total Index Preferensi</th>"; ?>
<?php  for ($i=0;$i<count($alternatif);$i++) {
  ...
  <div class="row">
    <div class="col-xs-8"> 
      <div class="box box-primary box-solid">
        ...
        <div class="box-body">
        	<div align="right">
             <input type="button" value="Perhitungan" 
             class="btn btn-primary btn-sm" 
             onclick="document.getElementById('perhitungan').style.display='block';"/> 
            </div>
