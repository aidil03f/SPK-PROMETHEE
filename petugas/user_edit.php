       ...
       <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
        <input type="hidden" name="id_user" value="<?php echo $result[0]['id_user'];?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" name="username" class="form-control" 
                       value="<?php echo $result[0]['username'];?>" readonly>
              </div>
           </div>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" name="akses_level" class="form-control"
                       value="<?php echo $result[0]['akses_level'];?>" readonly>
              </div>
           </div>
       ...
       if(isset($_POST['kirim'])){
          ...
          if($nama_photo != ''){
            ...
            $update = mysqli_query($connect, "UPDATE user SET
              ...
              ");
            if($update){
              echo "<script> alert('Data User Berhasil diubah'); window.location = '/spk_promethee1/petugas/user.php';</script>";
            }else{
              echo "<script> alert('Data User Gagal diubah'); window.location = '/spk_promethee1/petugas/user.php';</script>";
            }
